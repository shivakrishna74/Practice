...
public class SwaggerConfig {
    public static final springfox.documentation.service.Contact DEFAULT_CONTACT = new springfox.documentation.service.Contact(
            "Shiva Ramadugu", "http://in28minutes.com", "shivakrishnamnty@gmail.com");
    public static final ApiInfo DEFAULT_API_INFO=new ApiInfo("SRK Api Documentation",
            "SRK Api Documentation", "1.0", "urn:tos", DEFAULT_CONTACT,
